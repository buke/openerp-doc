...
.. i18n:  You will now see how OpenERP handles and simplifies this and the control of purchases from
.. i18n:  suppliers.*
..
 ...
 *In the preceding chapters you saw how to use customer invoices and delivery notes in OpenERP.
 ...
 suppliers.*
*在前面的章节中，你已经了解了在OpenERP如何使用客户发票和送货单。这章是关于采购管理，处理领先两个操作。你可以学习到
