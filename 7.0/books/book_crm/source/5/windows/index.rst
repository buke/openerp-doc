...
===============================
	...
	* All-In-One Installation
		This is the easiest way to install OpenERP in the shortest time. It installs all of the components (OpenERP Server, Client, Web and PostgreSQL database) pre-configured on one computer. This installation is recommended if you do not have any major customizations.
