...
module is described in detail in the chapter about sales (only in Logistics, not in Manufacturing).
...
Mechanisms used for encoding the hours worked will be covered in detail in the Human Resources chapter on line.
