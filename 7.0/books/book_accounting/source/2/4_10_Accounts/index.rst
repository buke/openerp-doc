...
.. note:: Independence from General Accounts
    ...
    In OpenERP, analytic accounts are linked to general accounts, but they are treated independently.
...
.. tip:: Who Benefits from Analytic Accounts?
        ...
        Unlike general accounts, analytic accounts in OpenERP are not so much an accounting tool for accountants as a
