...
.. i18n: To make a new lead, go to the :menuselection:`Sales --> Sales --> Leads` menu and click the `Create` button. In the **Lead** form that opens, you can enter the contact data of this new potential customer and add notes.
..
...
.. i18n: * ``New`` : the lead data have been entered, no work has been done yet and a salesperson has not
.. i18n:   yet been assigned to the request,
.. i18n: 
.. i18n: * ``Opportunity``: the lead has been converted into a partner and/or a sales opportunity,
.. i18n: 
...
.. i18n: On the :guilabel:`Extra` tab in the **Leads** form, you find information about the campaign, the channel, and so on.
..

On the :guilabel:`Extra` tab in the **Leads** form, you find information about the campaign, the channel, and so on.

.. i18n: .. figure:: images/crm_lead_extra.png
.. i18n:    :scale: 75
.. i18n:    :align: center
.. i18n: 
.. i18n:    *Extra Tab*
...
.. i18n: * Display a list of all the leads (New, open, Unassigned Leads, ...) according to the sales team you are linked to,
.. i18n: 
.. i18n: * Display a list of New leads by clicking `New`,
.. i18n: 
.. i18n: * Display Unassigned Leads by clicking `Unassigned Leads`,
.. i18n: 
.. i18n: * Display a list of all the leads assigned to different salespeople by clicking the Group by button `Salesperson`.
.. i18n: 
...
.. i18n: 2. How effective are your Campaigns? 
..
...
.. i18n: .. figure:: images/crm_lead_analysis.png
.. i18n:    :scale: 60
.. i18n:    :align: center
.. i18n: 
.. i18n:    *Leads Analysis*
