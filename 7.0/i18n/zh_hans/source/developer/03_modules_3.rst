...
.. i18n: As of v6.0, all search views also features custom search filters, as show below.
...
.. i18n:     The workflow signal may return an action descriptor, which should
.. i18n:     be executed. Otherwise it will return ``False``.
..
...
.. i18n:     list). This call may return an action descriptor to execute.
..
...
.. i18n:     From there, follows the normal action-execution workflow.
..
...
.. i18n: 
.. i18n:     <field name="order_line" colspan="4" nolabel="1"
.. i18n:            context="{'form_view_ref' : 'module.view_id', 'tree_view_ref' : 'model.view_id'}"/>
..
